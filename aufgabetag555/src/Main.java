...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // 500er
        double rest500 = betrag % 500;             // rest500: 1734€ insgesamt.. Was bleibt nach der Modulo Operation (z.b. 234€)
        double aufteilen = betrag - rest500;        // restWert: Was bleibt, wenn ich Rest vom Betrag abziehe 1734€ - 234 = 1500€
        double anzahl500 = aufteilen / 500;      // anzahl500: Anzahl an 500er - Scheinen 1500/500=anzahl500 ist gleich 3 (scheine)

        // 200er
        double rest200 = rest500 % 200;     // rest 500 ( = 234€ %200)
        aufteilen = rest500 - rest200;      // 200€ (aufteilen)= 234€ (rest 500) - 34€ (rest200) (234 % 200)
        double anzahl200 = aufteilen / 200;  // 1 Schein (anzahl200) = 200 / 200

        // 100er
        double rest100 = rest200 % 100;     //rest von den 200, 34€ euro von rest200
